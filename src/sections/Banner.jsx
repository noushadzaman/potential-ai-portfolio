    ...
    return (
        ...
        >
            ...
            <div className='tracking-[0.03em]'>
                ...
                <p className='font-[400] text-[21px] leading-[31.5px] max-w-xl mt-[28px]'>Lorem ipsum dolor sit amet consectetur. Tristique amet sed massa nibh lectus netus in. Aliquet donec morbi convallis pretium. Turpis tempus pharetra</p>
            ...
            <div className='flex flex-col items-center gap-[30px]'>
                <div className='relative max-w-[538px]'>
                    <img height={"617.24px"} width={"538px"} src={BannerImg} alt="" />
